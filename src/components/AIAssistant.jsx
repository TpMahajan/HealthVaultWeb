...
What would you like to know about your health today?`;
  ...
  const getQuickActions = () => {
    if (userRole === 'doctor') {
      return [
        { icon: Users, label: 'Active Session', action: 'Show me my active patients and their recent activity' },
      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-800 shadow-2xl flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {messages.map((message) => (
            ...
            >
              <div
                className={`max-w-xs lg:max-w-sm px-4 py-2 rounded-2xl ${message.type === 'user'
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex-1 relative">
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-full doctor-focus-ring dark:bg-gray-700 dark:text-gray-100"
                disabled={isLoading}
              />
            </div>
            <button
