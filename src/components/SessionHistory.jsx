...
const SessionHistory = () => {
    ...
    const fetchSessions = useCallback(async (isRefresh = false) => {
        try {
            ...
            const response = await fetch(`${API_BASE}/sessions/session-history`, {
                headers: {
...
<body>
    ...
    return (
        <div className="min-h-screen bg-[#F1F5F9] dark:bg-[#0A0A0A] p-8">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        <button
                            onClick={() => navigate(-1)}
                            className="p-2.5 bg-white dark:bg-[#121212] border border-gray-200 dark:border-white/5 rounded-xl text-slate-500 hover:text-primary dark:hover:text-primary hover:bg-primary-50 dark:hover:bg-primary/10 transition-all active-scale tooltip-trigger shadow-sm"
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            disabled={refreshing}
                            className="p-3 bg-white dark:bg-[#121212] border border-gray-200 dark:border-white/5 rounded-[16px] hover:bg-gray-50 dark:hover:bg-white/5 text-slate-600 dark:text-slate-300 transition-all shadow-sm active-scale tooltip-trigger disabled:opacity-50"
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="pl-10 pr-10 py-3 bg-white dark:bg-[#121212] border border-gray-200 dark:border-white/5 rounded-[16px] text-sm font-medium text-slate-900 dark:text-white placeholder:text-slate-400 focus:ring-2 focus:ring-primary/20 focus:border-primary w-full md:w-80 transition-all shadow-sm"
                            />
                            {searchTerm && (
                                <button
                                    onClick={() => setSearchTerm('')}
                                    className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-slate-400 hover:text-slate-600 dark:hover:text-amber-400 hover:bg-slate-100 dark:hover:bg-amber-400/10 rounded-lg transition-all z-10"
                                    title="Clear search"
                                >
                        ...
                        <button
                            ...
                            className={`p-3 border rounded-[16px] transition-all shadow-sm active-scale tooltip-trigger ${showFilters ? 'bg-slate-900 text-white border-slate-900' : 'bg-white dark:bg-[#121212] border-gray-200 dark:border-white/5 text-[#475569] dark:text-slate-300 hover:bg-gray-50'}`}
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-5 py-3 bg-primary hover:opacity-90 text-white rounded-xl text-sm font-bold shadow-md transition-all active:scale-95 whitespace-nowrap"
                        >
